...
from app.services import field_mapping, proto_center, render
...
def test_smoke(db):
    ...
    db.commit()
    pkg = ProtoPackage(name="t_nested", content=NESTED_PROTO, parsed=p2)
    db.add(pkg)
    db.commit()
    ...
    from app.services.metadata import mongo_d  # noqa: E402
    from app.api.pages.datasource import _build_connection  # noqa: E402
    from app.api.pages.job import _collect_options, _parse_mapping_form  # noqa: E402
